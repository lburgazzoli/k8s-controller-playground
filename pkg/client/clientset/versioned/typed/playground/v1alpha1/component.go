...
type components struct {
	*gentype.ClientWithListAndApply[*v1alpha1.Component, *v1alpha1.ComponentList, *playgroundv1alpha1.ComponentApplyConfiguration]
}

// newComponents returns a Components
func newComponents(c *PlaygroundV1alpha1Client, namespace string) *components {
	return &components{
		gentype.NewClientWithListAndApply[*v1alpha1.Component, *v1alpha1.ComponentList, *playgroundv1alpha1.ComponentApplyConfiguration](
			"components",
			c.RESTClient(),
