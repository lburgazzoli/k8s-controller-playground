	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlaygroundV1alpha1().Agents(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlaygroundV1alpha1().Agents(namespace).Watch(context.TODO(), options)
			},
		},
		&playgroundv1alpha1.Agent{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *agentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&playgroundv1alpha1.Agent{}, f.defaultInformer)
}
