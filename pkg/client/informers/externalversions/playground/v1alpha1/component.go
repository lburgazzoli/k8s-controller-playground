...
import (
	...
	versioned "github.com/lburgazzoli/k8s-controller-playground/pkg/client/clientset/versioned"
	internalinterfaces "github.com/lburgazzoli/k8s-controller-playground/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/lburgazzoli/k8s-controller-playground/pkg/client/listers/playground/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlaygroundV1alpha1().Components(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlaygroundV1alpha1().Components(namespace).Watch(context.TODO(), options)
			},
		},
		&playgroundv1alpha1.Component{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&playgroundv1alpha1.Component{}, f.defaultInformer)
}
